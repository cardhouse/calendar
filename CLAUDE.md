# Family Morning Dashboard - Project Guidelines

## IMPORTANT: Read Project Documentation First

Before starting any work on this project, AI agents MUST read the project documentation in `.ai/guidelines/`:

- **[PROJECT.md](.ai/guidelines/PROJECT.md)** - Project overview, vision, and success criteria
- **[ARCHITECTURE.md](.ai/guidelines/ARCHITECTURE.md)** - Technical architecture, patterns, and conventions
- **[FEATURES.md](.ai/guidelines/FEATURES.md)** - Detailed feature specifications and acceptance criteria
- **[DATA-MODELS.md](.ai/guidelines/DATA-MODELS.md)** - Database schema, models, and relationships
- **[UI-COMPONENTS.md](.ai/guidelines/UI-COMPONENTS.md)** - UI/UX guidelines and component specifications

These documents define what needs to be built and how. Always reference them when implementing features.
